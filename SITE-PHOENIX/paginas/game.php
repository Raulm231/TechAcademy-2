    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 text-center">
                <div class="jogoPlay">
                    <?php
                    $dadosGame = file_get_contents("http://localhost/lucas/TechAcademy-2/GameHeaven%20Site/api/games.php");
            ...
            <div class="row">
                <?php
                $dadosFotos = file_get_contents("http://localhost/TechAcademy-2/SITE-PHOENIX/api/fotos.php");
